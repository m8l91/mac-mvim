  ...
  lvim.builtin.which_key = {
    ...
    mappings = {
      ...
      l = {
        name = "LSP",
        a = { "<cmd>lua vim.lsp.buf.code_action()<cr>", "Code Action" },
        d = { "<cmd>lua vim.diagnostic.disable(vim.api.nvim_get_current_buf())<cr>", "Disable buffer Diagnostics" },
      ...
      s = {
        ...
        s = { "<cmd>Spectre toggle<cr>", "Toggle spectre" },
      },
      T = {
        name = "Treesitter",
      ...
      -- Window-Specific Minimap Controls
        ...
        O = { "<cmd>Neominimap Enable<cr>", "Enable global Minimap" },
        c = { "<cmd>Neominimap Disable<cr>", "Disable global Minimap" },
      ...
      -- Tab-Specific Minimap Controls
        ...
        o = { "<cmd>Neominimap winEnable<cr>", "Enable Minimap for current window" },
